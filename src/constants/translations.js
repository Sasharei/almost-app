export const TRANSLATIONS = {
  ru: {
    ...
    reportsInsightShare: "Сохранения составляют {{percent}}% решений. Попробуй довести до {{target}}%.",
    reportsInsightActiveDays: "Активных дней: {{active}} из {{total}}. Цель на период: {{target}}.",
    ...
    reportsInsightAvgTicket: "Средняя трата {{spendAvg}}, среднее сохранение {{saveAvg}}.",
    ...
    reportsNextStepGoal: "Поставь цель на следующий период и держи фокус.",
    ...
    dailyChallengeOfferHint: "Откажись хотя бы один раз и получишь ×2 монет.",
    ...
    dailyChallengeWidgetDesc: "День без «{{temptation}}» = ×2 монет",
  ...
  en: {
    ...
    reportsInsightShare: "{{percent}}% of decisions were saves. Aim for {{target}}%.",
    reportsInsightActiveDays: "Active days: {{active}} of {{total}}. Target {{target}} next period.",
    reportsInsightPeakSaveDay: "Best save day: {{day}} ({{amount}}).",
    reportsInsightPeakSpendDay: "Peak spending day: {{day}} ({{amount}}).",
    reportsInsightAvgTicket: "Average spend {{spendAvg}}, average save {{saveAvg}}.",
    ...
    reportsNextStepGoal: "Set a goal for the next period and stay focused.",
    ...
    reportsInsightShare: "{{percent}}% des décisions sont des économies. Vise {{target}}%.",
    reportsInsightActiveDays: "Jours actifs : {{active}} sur {{total}}. Objectif {{target}}.",
    reportsInsightPeakSaveDay: "Meilleure journée d’économies : {{day}} ({{amount}}).",
    reportsInsightPeakSpendDay: "Pic de dépense : {{day}} ({{amount}}).",
    reportsInsightAvgTicket: "Dépense moyenne {{spendAvg}}, économie moyenne {{saveAvg}}.",
    ...
    reportsNextStepGoal: "Fixe un objectif pour la prochaine période.",
  ...
  es: {
    ...
    reportsInsightShare: "{{percent}}% de las decisiones fueron ahorros. Apunta a {{target}}%.",
    reportsInsightActiveDays: "Días activos: {{active}} de {{total}}. Meta: {{target}}.",
    reportsInsightPeakSaveDay: "Mejor día de ahorro: {{day}} ({{amount}}).",
    reportsInsightPeakSpendDay: "Pico de gasto: {{day}} ({{amount}}).",
    reportsInsightAvgTicket: "Gasto medio {{spendAvg}}, ahorro medio {{saveAvg}}.",
    ...
    reportsNextStepGoal: "Fija una meta para el próximo periodo.",

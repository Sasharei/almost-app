...
export const TRANSLATIONS = {
  ru: {
    ...
    potentialBlockDetails:
      "Как это работает: берём сумму «мелких трат в месяц» и распределяем её по времени внутри текущего месяца — так получаем потенциал к текущему моменту. Каждая отмеченная трата уменьшает максимальный месячный потенциал, поэтому текущий потенциал тоже падает. Сейчас это {{potential}}, а реально сохранено {{actual}}.",
  ...
  en: {
    ...
    potentialBlockDetails:
      "How it works: we take your “small extras per month” amount and spread it over the current month to get potential by this moment. Each logged spend reduces the monthly max potential, so your current potential also drops. Right now it is {{potential}}, while your real logged savings are {{actual}}.",

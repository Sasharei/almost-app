export const TRANSLATIONS = {
  ru: {
    ...
    level2UnlockMessage:
      "Уровень 2! Ежедневная награда теперь в модалке Алми: на главном экране нажми на кота и забирай бонус каждый день. Мини-челлендж тоже появляется на главном экране, когда Almost посчитает нужным.",
    level3UnlockMessage:
    ...
    featureUnlockRewardsDailyDescription:
      "Ежедневная награда теперь внутри модалки Алми. На главном экране нажми на кота, открой модалку и забирай бонус раз в день - монеты сразу попадают к Алми, новая награда приходит завтра.",
  ...
  en: {
    ...
    level2UnlockMessage:
      "Level 2! Daily reward moved into the Almi modal: tap the cat on Home and claim your bonus once per day. The daily mini challenge will also appear on Home when Almost thinks you’re ready.",
    level3UnlockMessage:
    ...
    featureUnlockRewardsDailyDescription:
      "Daily reward is now inside the Almi modal. On Home, tap the cat, open the modal, and claim once per day; it resets tomorrow.",

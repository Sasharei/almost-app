export const TRANSLATIONS = {
  ru: {
    ...
    level6UnlockMessage:
      "Уровень 6! Открыта кастомизация Алми - на главном экране, нажми на кота.",
    level7UnlockMessage:
  ...
  en: {
    ...
    level6UnlockMessage: "Level 6! Almi customization is unlocked - on Home, tap the cat.",
    level7UnlockMessage:
    ...
    level6UnlockMessage:
      "Niveau 6 ! La personnalisation d’Almi est débloquée : sur l’accueil, touche le chat.",
    level7UnlockMessage:
  ...
  es: {
    ...
    level6UnlockMessage:
      "Nivel 6: La personalización de Almi está desbloqueada; en Inicio, toca el gato.",
    level7UnlockMessage:

export const TRANSLATIONS = {
  ru: {
    ...
    budgetPlannedLabel: "К распределению",
    ...
    incomeEntrySubtitle: "Новая функция: бюджет по доходу.",
    incomeEntryExplanation: "Сумма нужна, чтобы рассчитать лимиты, остаток месяца и подсказки по сбережениям.",
    incomeEntryVisualIncome: "Доход",
    incomeEntryVisualBudget: "Бюджет",
    incomeEntryVisualSavings: "Сбережения",
    incomeEntryAmountLabel: "Сумма дохода",
    ...
    reportsInsightShare: "{{percent}}% решений — сохранения. Попробуй довести до {{target}}%.",
    ...
    fabTutorialTitle: "Встречайте кнопку быстрого действия",
    fabTutorialDesc:
      "Теперь на главном экране она со значком валюты. Тапай, чтобы быстро записать трату или накопление, зажми, чтобы создать цель или искушение.",
  ...
  en: {
    ...
    incomeEntrySubtitle: "New feature: budget from your income.",
    incomeEntryExplanation: "We use it to calculate category limits, the month’s remaining balance, and savings suggestions.",
    incomeEntryVisualIncome: "Income",
    incomeEntryVisualBudget: "Budget",
    incomeEntryVisualSavings: "Savings",
    incomeEntryAmountLabel: "Income amount",
    ...
    incomeEntrySubtitle: "Nouvelle fonctionnalité : budget basé sur ton revenu.",
    incomeEntryExplanation:
      "Le montant sert à calculer les limites par catégorie, le reste du mois et des suggestions d’épargne.",
    incomeEntryVisualIncome: "Revenu",
    incomeEntryVisualBudget: "Budget",
    incomeEntryVisualSavings: "Épargne",
    incomeEntryAmountLabel: "Montant du revenu",
  ...
  es: {
    ...
    incomeEntrySubtitle: "Nueva función: presupuesto según tu ingreso.",
    incomeEntryExplanation:
      "Usamos el monto para calcular límites por categoría, el saldo del mes y sugerencias de ahorro.",
    incomeEntryVisualIncome: "Ingreso",
    incomeEntryVisualBudget: "Presupuesto",
    incomeEntryVisualSavings: "Ahorro",
    incomeEntryAmountLabel: "Monto del ingreso",

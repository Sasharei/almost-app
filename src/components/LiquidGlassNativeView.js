...
const COMPONENT_CANDIDATES = ["LiquidGlassNativeView", "LiquidGlassNativeViewManager"];
...
export const canUseNativeLiquidGlassView = () => !!resolveNativeComponent();

const LiquidGlassNativeView = ({ cornerRadius, tintAlpha, strokeOpacity, ...restProps }) => {
...
export default LiquidGlassNativeView;

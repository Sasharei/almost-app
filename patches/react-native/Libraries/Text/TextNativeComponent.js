...
const textViewConfig = {
  validAttributes: {
    ...
    // Fabric's native paragraph layout uses these absolute limits. Without
    // registering them here React Native drops the props and falls back to 4pt.
    minimumFontSize: true,
    maximumFontSize: true,

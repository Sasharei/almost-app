...
private fun nodeCommand(): String {
  ...
  listOfNotNull(
    System.getenv("EXPO_NODE_BINARY"),
    System.getenv("NODE_BINARY"),
    System.getProperty("expo.nodeBinary"),
    System.getProperty("nodeBinary")
  )
    .filter { !it.isNullOrBlank() }
    .forEach { candidateSet.add(it) }
  ...
  fun harvestFromPath(pathValue: String?) {
  ...
  harvestFromPath(System.getProperty("PATH"))
  harvestFromPath(System.getenv("PATH"))
